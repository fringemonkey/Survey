      ...
      <div className="notion-content py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-notion-text-secondary">
            Start with hardware specs (required), then choose any optional surveys you'd like to complete.
          </p>
        </div>
          ...
          <div className="bg-notion-bg-secondary rounded-lg p-6 border-2 border-red-500">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-notion-text-secondary">Required - Everyone completes this first</p>
        ...
        <div className="mb-8">
          ...
          <p className="text-notion-text-secondary mb-6">
            Complete any of these to provide additional feedback. Each takes ~2 minutes.
          </p>
            ...
            <div className="bg-notion-bg-secondary rounded-lg p-6 border border-notion-border">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-notion-text-secondary">FPS and stability feedback</p>
                  <p className="text-xs text-notion-text-secondary mt-1">5 questions</p>
                </div>
